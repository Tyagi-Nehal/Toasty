...
from (values
  ...
  -- 2026-07-30
  ('2026-07-30'::date, 'Advik', true),
  ('2026-07-30'::date, 'Ahana', true),
  ('2026-07-30'::date, 'Aman', true),
  ('2026-07-30'::date, 'Anish', true),
  ('2026-07-30'::date, 'Arjun', false),
  ('2026-07-30'::date, 'Ayman', false),
  ('2026-07-30'::date, 'Chozhan', false),
  ('2026-07-30'::date, 'Durva', true),
  ('2026-07-30'::date, 'Faizaan', true),
  ('2026-07-30'::date, 'Hritvik', true),
  ('2026-07-30'::date, 'Isha', true),
  ('2026-07-30'::date, 'Namita', true),
  ('2026-07-30'::date, 'Nehal', true),
  ('2026-07-30'::date, 'Nick', true),
  ('2026-07-30'::date, 'Parth', true),
  ('2026-07-30'::date, 'Ruhaani', false),
  ('2026-07-30'::date, 'Sarvajit', true),
  ('2026-07-30'::date, 'Srinidhi', false),
  ('2026-07-30'::date, 'Sripad', false),
  ('2026-07-30'::date, 'Swetha', true),
  ('2026-07-30'::date, 'Thasvin', false),
  ('2026-07-30'::date, 'Venkatakrishnan', true),
